...
ACTION_METADATA = {'execute_console_command': {'description': "Executes an editor console command (e.g. 'stat fps', "
 ...
 'get_cvar': {'description': 'Reads the current value of a console variable (CVar) as a string, '
                             "e.g. 'r.ScreenPercentage'.",
              'effect': 'read',
              'idempotent': True,
              'required_plugins': [],
              ...
              'title': 'Get Cvar',
              'ue_versions': ['5.6', '5.7', '5.8']},
 'get_output_log': {'description': 'Returns recent lines from the UE output log file; optional '
                                   'keyword filter with context_lines around each match.',
                    'effect': 'read',
                    'idempotent': True,
                    'required_plugins': [],
                    'requires_confirmation': False,
 ...
 'get_project_info': {'description': 'Returns project, engine, plugin, and editor capability information.',
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_viewport_camera': {'description': 'Returns the level viewport camera location and rotation.',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         'requires_confirmation': False,
                         ...
                         'supports_preview': False,
                         'supports_undo': False,
                         'title': 'Get Viewport Camera',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'is_in_pie': {'description': 'Returns whether Play-In-Editor is currently active.',
               'effect': 'read',
               'idempotent': True,
               'required_plugins': [],
               'requires_confirmation': False,
               ...
               'title': 'Is In Pie',
               'ue_versions': ['5.6', '5.7', '5.8']},
 'list_class_properties': {'asset_path_params': ['class_path'],
                           'description': 'Lists the editor-settable property names of a UClass '
                                          '(for discovering what set_property accepts).',
                           'effect': 'read',
                           'idempotent': True,
                           'required_plugins': [],
                           'requires_confirmation': False,
                           ...
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'list_enum_values': {'description': 'Lists the values of an Unreal enum by name (e.g. '
                                     "'TextureCompressionSettings', 'CollisionTraceFlag').",
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      'requires_confirmation': False,
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'print_message': {'description': 'Logs a message to the Unreal log and returns a JSON success '
                                  'response.',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': [],
                   ...
                   'title': 'Print Message',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'save_all_dirty': {'description': 'Saves all dirty packages (modified maps and content).',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    'requires_confirmation': True,
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'screen_to_world': {'description': 'Deprojects a viewport pixel (x, y) to a world location at '
                                    "'distance' along the view ray.",
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': [],
                     'requires_confirmation': False,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'set_cvar': {'description': "Sets a console variable, e.g. name='r.ScreenPercentage', value='75'. "
              ...
              'title': 'Set Cvar',
              'ue_versions': ['5.6', '5.7', '5.8']},
 'set_log_verbosity': {'description': "Sets a log category's verbosity via the 'Log' console "
                                      "command (e.g. 'LogBlueprint', 'Verbose').",
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
                       'requires_confirmation': True,
                       ...
                       'supports_preview': False,
                       'supports_undo': False,
                       'title': 'Set Log Verbosity',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'set_viewport_camera': {'description': 'Sets the level viewport camera. location=[x,y,z], '
 ...
 'stop_pie': {'description': 'Stops Play-In-Editor.',
              ...
              'title': 'Stop Pie',
              'ue_versions': ['5.6', '5.7', '5.8']},
 'world_to_screen': {'description': 'Projects a world location to active level-viewport pixel '
                                    'coords (editor viewport, no PIE needed).',
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': [],
                     'requires_confirmation': False,
