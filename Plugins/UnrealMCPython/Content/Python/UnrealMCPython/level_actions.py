...
ACTION_METADATA = {'create_level': {'asset_path_params': ['level_path'],
                  'description': 'Creates a new empty level and saves it at the given '
 ...
 'get_current_level_path': {'description': 'Returns the path of the currently open editor '
                                           'world/level.',
                            'effect': 'read',
                            'idempotent': True,
                            'required_plugins': [],
                            ...
                            'supports_undo': False,
                            'title': 'Get Current Level Path',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'list_level_actors': {'description': 'Lists all actors in the current level.',
                       'effect': 'read',
                       'idempotent': True,
                       'required_plugins': [],
                       'requires_confirmation': False,
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'load_level': {'asset_path_params': ['level_path'],
                'description': 'Opens (loads) an existing level in the editor.',
                'effect': 'destructive',
                'idempotent': False,
                'required_plugins': [],
                'requires_confirmation': True,
 ...
 'save_current_level': {'description': 'Saves the currently open level. Returns success=False for '
                        ...
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'set_world_settings': {'description': 'Modifies WorldSettings of the current level.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
