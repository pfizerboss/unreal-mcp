...
CATALOG = {
    ...
    'blueprint': {
        ...
        'delete_blueprint_function': {
            'params': "asset_path, function_id, allow_name_fallback=False, function_name='', function_owner_id='', function_type_path=''",
            'doc': 'Deletes a Blueprint function targeted by stable ID.',
        },
        'delete_blueprint_macro': {
            'params': "asset_path, macro_id, allow_name_fallback=False, macro_name='', macro_owner_id='', macro_type_path=''",
        ...
        'remove_blueprint_variable': {
            'params': "asset_path, variable_id, allow_name_fallback=False, variable_name='', variable_owner_id='', variable_type_path=''",
        ...
        'remove_event_dispatcher': {
            'params': "asset_path, dispatcher_id, allow_name_fallback=False, dispatcher_name='', dispatcher_owner_id='', dispatcher_type_path=''",
        ...
        'rename_blueprint_function': {
            'params': "asset_path, function_id, new_name, allow_name_fallback=False, function_name='', function_owner_id='', function_type_path=''",
            'doc': 'Renames a Blueprint function targeted by stable ID.',
        },
        'rename_blueprint_variable': {
            'params': "asset_path, variable_id, new_name, allow_name_fallback=False, variable_name='', variable_owner_id='', variable_type_path=''",
        ...
        'set_blueprint_function_signature': {
            'params': "asset_path, function_id, inputs, outputs, pure, const, access, category, description, allow_name_fallback=False, function_name='', function_owner_id='', function_type_path=''",
